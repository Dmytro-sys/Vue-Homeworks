...
vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_1__["default"].component('blog-list', {
  template: '<ul><slot></slot></ul>',
  created: function created() {
    console.log("blog-list created");
  }
});
vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_1__["default"].component('blog-item', {
  template: '<li>{{ title }}, {{ subtittle }}</li>',
  beforeCreate: function beforeCreate() {
    console.log("blog-item beforeCreate complete" + ", " + "data from app1 is ".concat(this.title));
  },
  created: function created() {
    this.title = this.$root.title;
    console.log("blog-item created complete" + ", " + "now we can get data from $root element, this.title = ".concat(this.title));
  },
  beforeMount: function beforeMount() {
    this.subtittle = this.$root.subtittle;
    console.log("blog-item beforeMount complete" + ", " + "let's take more data from app1, this.subtittle = ".concat(this.subtittle, "."), " this.$el is ".concat(this.$el, " yet, but it will soon created!"));
  },
  mounted: function mounted() {
    console.log("blog-item mounted complete" + ", " + "access to reactive component, templates and rendered DOM,\n    this.$el.textContent = ".concat(this.$el.textContent));
    this.$el.style.color = 'red';
    this.$el.style.fontSize = '26px';
    this.$el.style.listStyle = 'square';
  }
});
vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_1__["default"].component('first-component', {
  props: ['count'],
...
vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_1__["default"].component('second-component', {
  data: function data() {
    return {
      count: 0
    };
...
document.addEventListener('DOMContentLoaded', function () {
  var app1 = new vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
    el: '#app1',
    data: {
      title: 'Task list',
  ...
  var app2 = new vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
    el: '#app2',
    methods: {
